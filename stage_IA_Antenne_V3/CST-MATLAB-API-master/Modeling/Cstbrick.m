...
invoke(brick,'Xrange',num2str(Xrange(1)),num2str(Xrange(2)));
invoke(brick,'Yrange',num2str(Yrange(1)),num2str(Yrange(2)));
invoke(brick,'Zrange',num2str(Zrange(1)),num2str(Zrange(2)));
