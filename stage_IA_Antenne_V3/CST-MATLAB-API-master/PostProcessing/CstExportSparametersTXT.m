...
function CstExportSparametersTXT(mws, Sij_Name, exportpath)

S_ParamName = ['1D Results\S-Parameters\' Sij_Name];

invoke(mws,'SelectTreeItem',S_ParamName);

%invoke(mws,'SelectTreeItem','1D Results\S-Parameters\S2,1');
